...
def make_plot(det, time, timemax, SNR, eventname, plottype, tevent, template_match, template_fft, datafreq, d_eff, freqs, data_psd, pcolor, strain_whitenbp, fs, checker):
    if checker:
        # -- Plot the result
