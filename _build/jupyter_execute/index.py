...
from ligotools.utils import make_plot
...
for det in dets:
    ...
    if make_plots:
        ...
        if det is 'L1': 
            ...
            template_L1 = None
        make_plot(det, time, timemax, SNR, eventname, plottype, tevent, template_match, template_fft, datafreq, d_eff, freqs, data_psd, pcolor, strain_whitenbp, fs, True)        
